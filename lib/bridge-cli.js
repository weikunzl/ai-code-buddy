...
Usage:
  devpet-bridge restart          Kill stale listeners, start HTTP :19876 + WS :19877
  devpet-bridge start            Start only if ports are free
  devpet-bridge run [args...]    Run python3 -m bridge (pass-through flags)

Environment:
  BUDDY_HTTP_PORT   HTTP hook port (default 19876)
  BUDDY_WS_PORT     WebSocket port for phone (default 19877)
