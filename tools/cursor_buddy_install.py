...
Registers tools/cursor_hook.py against the relevant Cursor agent events in
...
Usage:
  ...
  python3 tools/cursor_buddy_install.py --print    # show planned hooks.json
"""
...
HOOK_SCRIPT = REPO_ROOT / "tools" / "cursor_hook.py"
